...
public class By_Group_Index_ff_ActiTime {
...
public static void main(String[]args) throws Throwable {
	...
	ffd.findElement(By.xpath("(//input)[3]")).sendKeys("admin");
	Thread.sleep(3000);
//	
	ffd.findElement(By.xpath("(//input)[4]")).sendKeys("manager");
	Thread.sleep(3000);
//	
	ffd.findElement(By.xpath("(//div)[13]")).click();
