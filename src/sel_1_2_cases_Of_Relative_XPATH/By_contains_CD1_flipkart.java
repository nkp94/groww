...
public class By_contains_CD1_flipkart {
public static void main(String[] args) throws Throwable {
	...
	cddriver.findElement(By.xpath("//input[contains(@class,'_2IX_2- VJZDxU')]")).sendKeys("9834753809");
	Thread.sleep(2000);
	
	cddriver.findElement(By.xpath("//input[contains(@class,'_2IX_2- _3mctLh VJZDxU')]")).sendKeys("Nils@1234");
	Thread.sleep(2000);
	
	cddriver.findElement(By.xpath("//button[contains(@class,'_2KpZ6l _2HKlqd _3AWRsL')]")).click();
